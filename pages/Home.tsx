...
export const Home: React.FC<HomeProps> = ({ onNavigate }) => {
  ...
  return (
    <div className="pb-32">
      {/* Hero Section */}
      <section className="relative pt-6 pb-2 lg:pt-8 lg:pb-3 overflow-hidden">
        <div className="absolute top-20 left-1/2 -translate-x-1/2 w-[200px] h-[100px] bg-purple-600/10 blur-[180px] rounded-full -z-10 animate-pulse-soft"></div>
        <div className="max-w-7xl mx-auto px-6 text-center">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/5 border border-white/10 text-[10px] font-bold uppercase tracking-[0.2em] text-purple-400 mb-5">
            Beginner-Friendly Workshop
          </div>
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-black tracking-tighter mb-3 leading-[1.05] whitespace-nowrap">
          Build Your Own Custom AI Assistant
          </h1>
          <p className="max-w-xl mx-auto text-slate-400 mb-3 leading-relaxed text-balance">
            A "Custom GPT" is a version of ChatGPT that's been given special instructions by you. No coding required. Just copy, paste, and create.
          </p>
          {/* <div className="flex flex-wrap justify-center gap-6">
            <button 
              onClick={() => onNavigate('copywriter')}
              className="px-10 py-5 bg-white text-black hover:bg-slate-200 rounded-xl font-black transition-all shadow-xl hover:scale-100 active:scale-95 flex items-center gap-3"
            >
              Start Building
